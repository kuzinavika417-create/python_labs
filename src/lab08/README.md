...
```
Для работы этого кода необходимо в терминале прописать команду : ``` python models.py ```
...
```
Для работы этого кода необходимо в терминале прописать команду : ``` python serialize.py ```
